...
rtl.module("program",["System","browserconsole","Web"],function () {
  "use strict";
  var $mod = this;
  this.canvas = null;
  this.ctx = null;
  ...
  this.InitCanvas = function () {
    ...
    $mod.canvas2 = document.getElementById("canvas_2");
    $mod.ctx2 = $mod.canvas2.getContext("2d");
    $mod.canvas3 = document.getElementById("canvas_3");
    $mod.ctx3 = $mod.canvas3.getContext("2d");
    $mod.canvas4 = document.getElementById("canvas_4");
    $mod.ctx4 = $mod.canvas4.getContext("2d");
  };
  this.Draw = function () {
    $mod.ctx.fillStyle = "green";
    $mod.ctx.fillRect(0,0,300,300);
    $mod.ctx2.fillStyle = "red";
    $mod.ctx2.fillRect(0,0,64,64);
    $mod.ctx2.fillStyle = "white";
    $mod.ctx2.fillText("Hello World",5,35);
    $mod.ctx.drawImage($mod.canvas2,10,100);
    $mod.ctx3.fillStyle = "blue";
    $mod.ctx3.fillRect(0,0,64,64);
    $mod.ctx3.fillStyle = "white";
    $mod.ctx3.fillText("Hello World",5,35);
    $mod.ctx.drawImage($mod.canvas3,100,100);
    $mod.ctx4.fillStyle = "orange";
    $mod.ctx4.fillRect(0,0,64,64);
    $mod.ctx4.fillStyle = "white";
    $mod.ctx4.fillText("Hello World",5,35);
    $mod.ctx.drawImage($mod.canvas4,190,100);
  };
  $mod.$main = function () {
    $mod.InitCanvas();
    $mod.Draw();
    pas.System.Writeln("drawImage");
  };
});
