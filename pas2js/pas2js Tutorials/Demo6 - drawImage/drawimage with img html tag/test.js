...
rtl.module("program",["System","browserconsole","Web"],function () {
  ...
  this.Draw = function () {
    ...
    $mod.myImage = document.getElementById("myImage_id");
    $mod.ctx.drawImage($mod.myImage,100,100);
  };
  this.onLoadImageDraw = function (Event) {
    var Result = false;
    pas.System.Writeln("all images loaded!");
    $mod.Draw();
    return Result;
  };
  $mod.$main = function () {
    ...
    window.onload = rtl.createSafeCallback($mod,"onLoadImageDraw");
  };
});
