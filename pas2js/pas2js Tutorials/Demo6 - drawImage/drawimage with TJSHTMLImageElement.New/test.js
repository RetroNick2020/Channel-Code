...
rtl.module("program",["System","browserconsole","Web"],function () {
  ...
  this.LoadDrawImage = function (x, y, ctx, url) {
    var myImage = null;
    ...
    myImage = new Image();
    myImage.src = url;
    myImage.onload = rtl.createSafeCallback(null,onload);
  };
  this.Draw = function () {
    $mod.ctx.fillStyle = "green";
    $mod.ctx.fillRect(0,0,300,300);
    $mod.LoadDrawImage(10,10,$mod.ctx,"myImage.png");
    $mod.LoadDrawImage(80,80,$mod.ctx,"myImage2.png");
  };
  $mod.$main = function () {
    $mod.InitCanvas();
    $mod.Draw();
