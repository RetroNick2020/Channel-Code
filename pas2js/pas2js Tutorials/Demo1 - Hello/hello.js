...
rtl.module("test1",["System"],function () {
  "use strict";
  var $mod = this;
  this.writesomething = function () {
    pas.System.Writeln("something from test1 unit");
  };
  $mod.$init = function () {
  };
});
rtl.module("program",["System","browserconsole","test1"],function () {
  "use strict";
  var $mod = this;
  $mod.$main = function () {
    pas.System.Writeln("Hello World");
    pas.test1.writesomething();
  };
});
