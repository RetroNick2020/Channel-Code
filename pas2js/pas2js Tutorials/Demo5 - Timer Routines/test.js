...
rtl.module("program",["System","browserconsole","Web"],function () {
  ...
  this.InitBoxLocations = function () {
    $mod.box1_y = 0;
    $mod.box2_y = 0;
  };
  ...
  this.MoveBox2 = function () {
    $mod.box2_y += 5;
  };
  this.StopBoxes = function () {
    window.clearInterval($mod.timer1_id);
  };
  this.DrawBoxes = function () {
    $mod.ctx.fillStyle = "green";
    $mod.ctx.fillRect(0,0,300,300);
    $mod.ctx.fillStyle = "red";
    $mod.ctx.fillRect(100,$mod.box1_y,20,20);
    $mod.ctx.fillStyle = "white";
    $mod.ctx.fillRect(150,$mod.box2_y,20,20);
  };
  $mod.$main = function () {
    pas.System.Writeln("Timer Events");
    $mod.InitBoxLocations();
    $mod.InitCanvas();
    $mod.timer1_id = window.setInterval(rtl.createSafeCallback($mod,"MoveBox1"),500);
    $mod.timer2_id = window.setInterval(rtl.createSafeCallback($mod,"MoveBox2"),400);
    $mod.timer3_id = window.setInterval(rtl.createSafeCallback($mod,"DrawBoxes"),300);
    window.setTimeout(rtl.createSafeCallback($mod,"StopBoxes"),20000);
  };
});
