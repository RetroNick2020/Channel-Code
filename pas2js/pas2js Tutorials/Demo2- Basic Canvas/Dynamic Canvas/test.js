...
rtl.module("program",["System","browserconsole","Web"],function () {
  ...
  this.drawSomething = function () {
    ...
    $mod.canvas.width = 400;
    $mod.canvas.height = 400;
    $mod.canvas.id = "canvas_2";
    document.body.appendChild($mod.canvas);
    $mod.ctx = $mod.canvas.getContext("2d");
    $mod.ctx.fillStyle = "red";
    $mod.ctx.fillRect(10,10,250,100);
    $mod.ctx.fillStyle = "blue";
    $mod.ctx.font = "48px serif";
    $mod.ctx.fillText("Hello world",20,80);
  };
  $mod.$main = function () {
    pas.System.Writeln("Draw in Canvas");
    $mod.drawSomething();
  };
});
