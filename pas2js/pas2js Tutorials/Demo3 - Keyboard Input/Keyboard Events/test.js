...
rtl.module("program",["System","browserconsole","Web"],function () {
  "use strict";
  var $mod = this;
  this.HandleKeyUp = function (k) {
    var Result = false;
    pas.System.Writeln("A key was released");
    pas.System.Writeln("code=",k.code);
    pas.System.Writeln("key=",k.key);
    return Result;
  };
  $mod.$main = function () {
    pas.System.Writeln("Keyboard Events");
    document.onkeyup = rtl.createSafeCallback($mod,"HandleKeyUp");
  };
});
