...
rtl.module("program",["System","browserconsole","Web"],function () {
  ...
  this.DrawSomething = function () {
    ...
    $mod.ctx.fillRect(100,100,100,100);
  };
  this.HandleMouseClick = function (Event) {
    var Result = false;
    pas.System.Writeln("Mouse was clicked in Canvas Area");
    pas.System.Writeln("offsetX =",Event.offsetX);
    pas.System.Writeln("offsetY =",Event.offsetY);
    pas.System.Writeln("x =",Event.clientX);
    pas.System.Writeln("y =",Event.clientY);
    return Result;
  };
  this.HandleMouseMove = function (Event) {
    var Result = false;
    pas.System.Writeln("Mouse was moved in Canvas Area");
    pas.System.Writeln("offsetX =",Event.offsetX);
    pas.System.Writeln("offsetY =",Event.offsetY);
    pas.System.Writeln("x =",Event.clientX);
    pas.System.Writeln("y =",Event.clientY);
  ...
  this.InitMouseHandler = function () {
    $mod.canvas.addEventListener("click",$mod.HandleMouseClick);
    $mod.canvas.addEventListener("mousemove",$mod.HandleMouseMove);
  };
  $mod.$main = function () {
    pas.System.Writeln("Mouse Events");
    $mod.InitCanvas();
    $mod.InitMouseHandler();
    $mod.DrawSomething();
  };
});
