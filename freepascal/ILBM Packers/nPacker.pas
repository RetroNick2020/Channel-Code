(* Nick's Experimental packbits packers                      *)
(* implements cmprun1 in a compatible but different way then *)
(* standard  Deluxe Paint C packbits code                    *)
