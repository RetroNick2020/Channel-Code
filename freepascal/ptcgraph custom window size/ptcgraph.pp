...
type
//Added by RetroNick
  CustomWindowGraphProc=Procedure(var AWidth, AHeight : Integer);

 //Added by RetroNick
procedure InitGraphWindowCustom(CW : CustomWindowGraphProc);
...
//Added By RetroNick
  CustomWindowGraph : Boolean = False;
...
var
  ...
  //added by RetroNick
  GetCustomWindowGraphProc : CustomWindowGraphProc;

//Added bt RetroNick
procedure InitGraphWindowCustom(CW : CustomWindowGraphProc);
begin
  CustomWindowGraph:=True;
  GetCustomWindowGraphProc:=CW;
end;
...
begin
  ...
  //Added by RetroNick
  if CustomWindowGraph then GetCustomWindowGraphProc(ConsoleWidth,ConsoleHeight);
